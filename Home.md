...
tags: #internship #moc #dashboard

This is the starting page for the internship vault.

## Daily logs

Use daily logs to remember what happened on a specific day.
...
## How to keep using this vault

When typing fast notes, do not worry about perfect format. Send the raw note to ChatGPT later, then keep both:

- raw note in `00 Raw/`
- cleaned notes split into daily logs and reusable topic notes

See [[Raw Note Capture Template]] and [[ChatGPT Note Cleanup Workflow]].
